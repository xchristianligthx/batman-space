...
function preload(){
  ...
  towerImg = loadImage("kisspng-galaxy-color-desktop-wallpaper-nebula-star-space-5ab949530d7697.6824703015220923710552.jpg");
  doorImg = loadImage("door.png");
  climberImg = loadImage("climber.png");
  ghostImg = loadImage("13051_batman-arkham-knight-prev.png");
 //spookySound = loadSound("spooky.wav");
 //nirvanaSound = loadSound("the-man-who-sold-the-world-mtv-unplugged (1).mp3");
}
//spooky.wav
function setup() {
